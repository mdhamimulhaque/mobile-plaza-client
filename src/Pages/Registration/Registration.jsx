                ...
                <div className="md:flex w-full">
                    ...
                    <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                        <div className="text-center mb-10">
                            <h1 className="font-bold text-3xl lg:text-4xl">Registration</h1>
                        ...
                        <form onSubmit={handleSubmit(handleRegistration)}>
                                ...
                                <div className="w-full px-3 mb-5">
                                    ...
                                    <div className="flex">
                                        <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                            <HiOutlineUser className="mdi mdi-email-outline text-gray-400 text-lg" />
                                        </div>
                                        <input id='name'
                                            type="name"
                                            className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-600"
                            ...
                            <div className="flex -mx-3">
                                <div className="w-full px-3 mb-5">
                                    ...
                                    <div className="flex">
                                        <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                            <HiOutlineDevicePhoneMobile className="mdi mdi-email-outline text-gray-400 text-lg" />
                                        </div>
                                        <input type="number"
                                            id='phone'
                                            className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-600"
                            ...
                            <div className="flex -mx-3">
                                <div className="w-full px-3 mb-5">
                                    ...
                                    <div className="flex">
                                        <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                            <HiOutlineEnvelope className="mdi mdi-email-outline text-gray-400 text-lg" />
                                        </div>
                            ...
                            <div className="flex -mx-3">
                                <div className="w-full px-3 mb-5">
                                    ...
                                    <div className="flex">
                                        <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                            <HiOutlineLockClosed className="mdi mdi-email-outline text-gray-400 text-lg" />
                                        </div>
                            ...
                            <div className="user_role">
                                <div className="flex flex-col gap-1">
                                    <label htmlFor='role' className="text-xs font-semibold px-1">Account Type</label>
                            ...
                            <p className='text-red-400 text-center my-2'>{regiError}</p>

                            <div className="flex -mx-3 my-5">
                                <div className="w-full px-3 mb-5">
                                    <button className="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-1 py-3 font-semibold">REGISTER NOW</button>
                                </div>
                            </div>
                        </form>
                    </div>
