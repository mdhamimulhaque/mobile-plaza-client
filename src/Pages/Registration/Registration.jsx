...
import { HiOutlineUser, HiOutlineDevicePhoneMobile, HiOutlineEnvelope } from "react-icons/hi2";
                ...
                <div class="md:flex w-full">
                    ...
                    <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                        <div class="text-center mb-10">
                            <h1 class="font-bold text-3xl lg:text-4xl">REGISTER</h1>
                        ...
                        <form onSubmit={handleSubmit(handleRegistration)}>
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    <label htmlFor='name' class="text-xs font-semibold px-1">Name</label>
                                    <div class="flex">
                                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                            <HiOutlineUser class="mdi mdi-email-outline text-gray-400 text-lg" />
                                        </div>
                                        <input id='name'
                                            type="name"
                                            class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-600"
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    <label htmlFor='phone' class="text-xs font-semibold px-1">Phone</label>
                                    <div class="flex">
                                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                            <HiOutlineDevicePhoneMobile class="mdi mdi-email-outline text-gray-400 text-lg" />
                                        </div>
                                        <input type="number"
                                            id='phone'
                                            class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-600"
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    <label htmlFor='email' class="text-xs font-semibold px-1">Email</label>
                                    <div class="flex">
                                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                            <HiOutlineEnvelope class="mdi mdi-email-outline text-gray-400 text-lg" />
                                        </div>
                            ...
                            <div className="user_role">
                                <div class="flex flex-col gap-1">
                                    <label htmlFor='role' class="text-xs font-semibold px-1">Account Type</label>
                                    <select id='role' class="pl-2 pr-3 py-2 mb-4 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-600"
                                        {...register('role')}
                                    >
                                        <option>user</option>
                            ...
                            <div class="flex -mx-3 my-5">
                                <div class="w-full px-3 mb-5">
                                    <button class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-1 py-3 font-semibold">REGISTER NOW</button>
                                </div>
                            </div>
                        </form>
                    </div>
